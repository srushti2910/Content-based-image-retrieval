...
def index():
    if request.method == 'POST':
        ...
        uploaded_img_path = 'test/' + datetime.now().isoformat().replace(":", ".") + "_" + file.filename
        ...
        if dists[idx[-1]] > 1:
            ...
            msg2 = 'http://127.0.0.1:8887/dataset/' + images[idx[-1]]
        for i in idx:
            img_dir = 'http://127.0.0.1:8887/dataset/' + images[i]
